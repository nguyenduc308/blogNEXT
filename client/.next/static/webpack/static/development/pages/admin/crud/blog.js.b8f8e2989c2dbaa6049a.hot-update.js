...
var ReactQuill = next_dynamic__WEBPACK_IMPORTED_MODULE_3___default()(function () {
  return __webpack_require__("./components/crud lazy recursive")(ReactQuill);
}, {
  ssr: false,
  loadableGenerated: {
    webpack: function webpack() {
      return [/*require.resolve*/(__webpack_require__("./components/crud weak recursive").resolve(ReactQuill))];
    },
    modules: [ReactQuill]
  }
});
...
var BlogCreate = function BlogCreate(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, "\xE2f");
};
...
//# sourceMappingURL=blog.js.b8f8e2989c2dbaa6049a.hot-update.js.map