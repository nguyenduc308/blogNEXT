...
/* harmony import */ var _helpers_reactQuill__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../helpers/reactQuill */ "./helpers/reactQuill.js");
...
var BlogCreate = function BlogCreate(_ref) {
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    Object(_actions_blog__WEBPACK_IMPORTED_MODULE_8__["create"])(formData, token).then(function (data) {
      if (data.error) {
        setValues(_objectSpread({}, values, {
          error: data.error
        }));
  ...
  var createBlogForm = function createBlogForm() {
    return __jsx("form", {
      ...
      modules: _helpers_reactQuill__WEBPACK_IMPORTED_MODULE_10__["quillmodules"],
      formats: _helpers_reactQuill__WEBPACK_IMPORTED_MODULE_10__["quillformats"],
      value: body,
...
//# sourceMappingURL=blog.js.c2bf8ae1ae71aed40a79.hot-update.js.map